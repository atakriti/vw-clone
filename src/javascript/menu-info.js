...
let list1 = () => {
  if (menu1.style.display === "none") {
      ...
      menu1.style.animationDuration = "1s"
    //   =========
    menu2.style.display = "none";
    menu3.style.display = "none";
    menu4.style.display = "none";
...
let list2 = () => {
  if (menu2.style.display === "none") {
      ...
      menu2.style.animationDuration = "1s"
    //   =======
    menu1.style.display = "none";
    menu3.style.display = "none";
    menu4.style.display = "none";
...
let list3 = () => {
  if (menu3.style.display === "none") {
      ...
      menu3.style.animationDuration = "1s"
    //   =======
    menu1.style.display = "none";
    menu2.style.display = "none";
    menu4.style.display = "none";
...
let list4 = () => {
  if (menu4.style.display === "none") {
      ...
      menu4.style.animationDuration = "1s"
    //   ========
    menu1.style.display = "none";
    menu2.style.display = "none";
    menu3.style.display = "none";
...
let list5 = () => {
  if (menu5.style.display === "none") {
      ...
      menu5.style.animationDuration = "1s"
    //   ===========
    menu1.style.display = "none";
    menu2.style.display = "none";
    menu3.style.display = "none";
...
let list6 = () => {
  if (menu6.style.display === "none") {
      ...
      menu6.style.animationDuration = "1s"
    //   ============
    menu1.style.display = "none";
    menu2.style.display = "none";
    menu3.style.display = "none";
...
let back1= () => {
    if (menu1.style.display === "block") {
        setTimeout(() => (menu1.style.display = "none"), 1000)
        menu1.style.animationName = "back"
        menu1.style.animationDuration = "1s"
        // =========
        setTimeout(() => (ulCon.style.display = "block"), 500)
    setTimeout(() => (ulLinks.style.display = "block"), 500)
    } else {
...
let back2 = () => {
    if (menu2.style.display === "block") {
        setTimeout(() => (menu2.style.display = "none"), 1000)
...
let back3 = () => {
    if (menu3.style.display === "block") {
        setTimeout(() => (menu3.style.display = "none"), 1000)
...
let back4 = () => {
    if (menu4.style.display === "block") {
        setTimeout(() => (menu4.style.display = "none"), 1000)
...
let back5 = () => {
    if (menu5.style.display === "block") {
        setTimeout(() => (menu5.style.display = "none"), 1000)
...
let back6 = () => {
    if (menu6.style.display === "block") {
        setTimeout(() => (menu6.style.display = "none"), 1000)
